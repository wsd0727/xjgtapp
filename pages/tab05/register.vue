  ...
  <view id="register">
    ...
    <view class="register_info">
      <ul>
       ...
       <li class="uni-flex">
          <input type="number" v-model="Form.UserPhone" maxlength="11" placeholder="请输入手机号码" />
        </li>
        <li class="uni-flex">
          <input type="text" v-model="Form.SJIDCARD" maxlength="18" placeholder="请输入身份证号码" />
        </li>
        <li class="uni-flex">
...
export default {
  ...
  methods: {
    ...
    register() {
      ...
      }else if( this.$utils.isCardID(this.Form.SJIDCARD) != true ){
      ...
      uni.request({
        url: HOST + '/api/BA_User/RegisterAccount',
        method: "POST",
        data: _self.Form,
        success: res => {
					console.log(res);
